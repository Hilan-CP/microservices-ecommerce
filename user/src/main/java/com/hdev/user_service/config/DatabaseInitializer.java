...
public class DatabaseInitializer {
    ...
    public void initialize(){
        ...
        User u1 = new User("691388fad21409a954c87fc9", null, "Vitor", "Hugo", "vitor.hugo@email.com", "44987654321", UserRole.ADMIN, a1, Instant.parse("2025-10-01T12:00:00Z"), null);
        User u2 = new User("691388fad21409a954c87fca", null, "Alexandre", "Tavares", "ale.tavares@email.com", "44912345678", UserRole.CUSTOMER, a2, Instant.parse("2025-10-01T12:00:00Z"), null);
        repository.save(u1);
        repository.save(u2);
    }
}
